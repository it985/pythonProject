...
#     :return: 返回Token
#     """
#     url = 'https://www.halo.icu/api/admin/login'
#     data = {
#         'username': username,
#         'password': password,
#     }
...
#     """
#     if type:
#         url = 'https://www.halo.icu/api/admin/sheets?page=0&size=100'
#     else:
#         url = 'https://www.halo.icu/api/admin/sheets/independent'
...
#     :return: 返回标签数据
#     """
#     url = 'https://www.halo.icu/api/admin/tags?more=true'
#     res = requests.get(url=url, headers=headers)
#     data = json.loads(res.text)['data']
#     return data
...
#     :return: 返回分类目录数据
#     """
#     url = 'https://www.halo.icu/api/admin/categories'
#     res = requests.get(url=url, headers=headers)
#     data = json.loads(res.text)['data']
#     return data
...
#     url = 'https://www.halo.icu/api/admin/tags'
#     data = {
#         "name": name,
#         "slug": slug,
#         "thumbnail": thumbnail,
...
#     :return: 返回响应数据
#     """
#     url = 'https://www.halo.icu/api/admin/posts'
#     data = {
#         "title": title,
